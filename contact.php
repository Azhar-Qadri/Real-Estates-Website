<?php
 require('include/header.php'); 
    ...
    if(isset($_POST['submit'])){
       ...
       $run=mysqli_query($con,"INSERT INTO `contact_us`(name, email, subject, comment, added_on) VALUES ('$name','$email','$subject','$comment','$added_on')"); 
       ?>
              ...
              <div class="col-md-7">
                <form  method="post" id="frm">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea name="comment" class="form-control"  cols="45" rows="8" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                        <div class="validate"></div>
                      </div>
                    </div>
