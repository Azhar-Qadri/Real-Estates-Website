        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $_SESSION['ADMIN_NAME']; ?></h3>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Email </b> <a class="float-right"><?php echo $_SESSION['ADMIN_EMAIL']; ?></a> 
                    <br>
                    <b>Date & Time </b> <a class="float-right"><?php echo $_SESSION['storeDate']; ?> | <?php  echo $_SESSION['storeTime']; ?></a>
                </li>
                </ul>
